  ...
  <div class="summary-container">
    ...
    <div class="analysis-section">
      ...
      <div class="analysis-grid">
        ...
        <div class="analysis-item">
          <div class="label">平均呼吸频率</div>
          <div class="value">{{ averageBreathingRate }}</div>
          <div class="description">
            每分钟呼吸次数
          </div>
        </div>
        ...
        <div class="analysis-item">
          <div class="label">心率变异性</div>
          <div class="value">{{ hrvScore }}</div>
          <div class="description">
            反映自主神经系统的调节能力
          </div>
        </div>
      ...
      <div class="recommendations">
        <h4>训练建议</h4>
        <ul>
          <li v-for="(tip, index) in trainingTips" :key="index">
            {{ tip }}
          </li>
        </ul>
      </div>
