  ...
  actions: {
    async initializeSettings(): Promise<void> {
      try {
        ...
        if (savedSettings) {
          ...
          this.defaultTrainingDuration = settings.defaultTrainingDuration || 15;
        }
      } catch (error) {
    ...
    async saveSettings(settings: Partial<Settings>): Promise<void> {
      try {
        ...
        if (settings.defaultTrainingDuration !== undefined) {
          this.defaultTrainingDuration = settings.defaultTrainingDuration;
        }
